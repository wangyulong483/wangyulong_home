...
.header h1 { color: #5a4fcf; font-size: 2.2rem; position: relative; z-index: 2 }

.app-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(200px, 1fr)); gap: 18px; padding: 0 10px }
